...
public class BasicExample extends Div {
    ...
    public BasicExample() {
        ...
        fileItem.addContextMenuClickListener(e -> {
            ...
            Notification.show(e.getRow().get(1).getCellValue());
        });
...
//        });
    ...
    private List<Item> getTableData() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            TableData.add(new GuiItem(7, List.of("Make Out", "LANY", "EP;", "Electronic", "2015-12-11", "12000", "8005", "9000"), headers));
            TableData.add(new GuiItem(8, List.of("Get Lucky", "Daft Punk", "Single", "Pop,Funk", "2013-04-23", "9000", "11000", "1500"), headers));
            TableData.add(new GuiItem(9, List.of("Valtari", "Sigur Rós", "EP;", "Rock", "2012-05-31", "10000", "9000", "8010"), headers));
            TableData.add(new GuiItem(10, List.of("Bush", "Snoop Dogg", "EP", "Hiphop", "2015-05-12", "18000", "3000", "2005"), headers));
            TableData.add(new GuiItem(11, List.of("Chaos And The Calm", "James Bay", "EP", "Pop,Rock", "2015-03-23", "12000", "8007", "9000"), headers));
            TableData.add(new GuiItem(12, List.of("4", "Beyoncé", "Deluxe", "Pop", "2011-07-26", "12000", "7000", "11002"), headers));
            TableData.add(new GuiItem(13, List.of("I Won't Give Up", "Jason Mraz", "Single", "Pop", "2012-01-03", "7000", "8000", "2000"), headers));
            TableData.add(new GuiItem(14, List.of("Following My Intuition", "Craig David", "Deluxe", "R&B,Electronic", "2016-10-01", "15000", "9001", "8100"), headers));
            TableData.add(new GuiItem(15, List.of("Blue Skies", "Lenka", "Single", "Pop,Rock", "2015-03-18", "6000", "11000", "9000"), headers));
            TableData.add(new GuiItem(16, List.of("This Is Acting", "Sia", "EP", "Pop", "2016-10-22", "20000", "11400", "5800"), headers));
            TableData.add(new GuiItem(17, List.of("Blurryface", "Twenty One Pilots", "EP", "Rock", "2015-05-19", "13000", "6010", "3020"), headers));
            TableData.add(new GuiItem(18, List.of("I am Not The Only One", "Sam Smith", "Single", "Pop,R&B", "", "", "", ""), headers));
        }
